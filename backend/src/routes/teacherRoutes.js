...
const { teacherProfileBodySchema, teacherQuestionBodySchema, idParamSchema, replyBodySchema } = require('../validations/teacherValidation');
...
router.put('/profile', authenticate, authorize('teacher', 'admin'), validateRequest({ body: teacherProfileBodySchema }), teacherProfileController.updateProfile);

router.get('/questions', authenticate, authorize('teacher', 'admin'), teacherQuestionController.getQuestions);
router.post('/questions', authenticate, authorize('teacher', 'admin'), validateRequest({ body: teacherQuestionBodySchema }), teacherQuestionController.createQuestion);
router.put(
	'/questions/:id',
	authenticate,
...
router.delete('/questions/:id', authenticate, authorize('teacher', 'admin'), validateRequest({ params: idParamSchema }), teacherQuestionController.deleteQuestion);
