      ...
      <div className="content-lesson-detail">
        ...
        {lesson ? (
          <div className="lesson-container">
            ...
            {/* Scroll target cho Phát Video ở phần dưới */}
            <div ref={playerRef} style={{ height: 1 }} />
                      ...
                      {item.type === 'videoClip' && (
                        <div className="form-group-segment">
                          ...
                          <small style={{ color: '#6b7280', display: 'block', marginTop: 6 }}>
                            Mỗi mục video có thể dùng một link YouTube riêng. Nếu để trống, hệ thống sẽ dùng video gốc của bài học nếu có.
                          </small>
                        </div>
                      )}
                      {item.type === 'videoClip' && (
